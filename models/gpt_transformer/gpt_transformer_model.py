...
class Transformer(nn.Module):
    ...
    def __init__(self, dim_self: int, num_heads: int, num_layers: int,
                 mlp_ratio: float = 2., act=nnf.relu, norm_layer: nn.Module = nn.LayerNorm, enc_dec = False):
...
class GPTTransformerModel(nn.Module):
    ...
    def __init__(self, prefix_length, clip_length, prefix_size=512, num_layers=8):
        """
        ...
        self.clip_project = TransformerModel(prefix_size, self.gpt_embedding_size, prefix_length, clip_length,
                                        num_layers)
